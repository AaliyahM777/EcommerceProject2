...
function App() {
  return (
    <div>
      <div>
        {/* Home Page Header */}
        <h1 class="index-header">Welcome To PenPowers</h1>
      </div>
      <div>
        <Carousel />
      </div>
      ...
      <div class="whatstyle">
        ...
        <div>
          <h3>Business</h3>
          <img class="index-img" src="https://www.marketleader.com/wp-content/uploads/2018/11/office-3295556_960_720.jpg" alt="Business" />
          <p>For those in professional workplaces</p>
        </div>
        <div>
          <h3>Arts & Crafts</h3>
          <img class="index-img" src="https://www.jacksonsart.com/blog/wp-content/uploads/2016/10/Drawing_Pens__Inks_Atmos.jpg" alt="Arts & Crafts" />
